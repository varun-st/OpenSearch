 ...
 */
public class StatsMetricTranslator implements CompositeMetricTranslator<StatsAggregationBuilder> {
    ...
    @Override
    public List<AggregateCall> toAggregateCalls(StatsAggregationBuilder agg, AggregationConversionContext ctx)
    ...
    public InternalAggregation buildEmptyAggregation(String name) {
        return new InternalStats(name, 0, 0, Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY, DocValueFormat.RAW, null);
    }
}
