...
public class HistogramGroupingTest {
    ...
    public void testGetFieldNames() {
        HistogramGrouping grouping = new HistogramGrouping("price", 100.0, 0.0);
    ...
    public void testGetProjectedColumnName() {
        HistogramGrouping grouping = new HistogramGrouping("price", 100.0, 0.0);
        assertEquals("price_histogram_bucket", grouping.getProjectedColumnName());
    }

    @Test
    public void testBuildExpression() throws ConversionException {
        HistogramGrouping grouping = new HistogramGrouping("price", 100.0, 5.0);
    ...
    public void testBuildExpressionWithInvalidField() throws ConversionException {
        HistogramGrouping grouping = new HistogramGrouping("invalid_field", 100.0, 0.0);
