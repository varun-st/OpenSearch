...
public class HistogramBucketShapeTest {

    private HistogramBucketShape shape;
    private HistogramAggregationBuilder agg;

    @Before
    public void setUp() {
        shape = new HistogramBucketShape();
    ...
    @Test
    public void testGetMinDocCountDefault() {
    ...
    public void testToBucketAggregationWithMinDocCountZero() {
        ...
        // This test verifies the minDocCount=0 workaround. Without it, InternalHistogram
