...
public class DateHistogramGroupingTest {
    ...
    public void testGetFieldNames() {
        DateHistogramGrouping grouping = new DateHistogramGrouping("timestamp", DateHistogramInterval.MONTH, null);
    ...
    public void testGetProjectedColumnName() {
        DateHistogramGrouping grouping = new DateHistogramGrouping("timestamp", DateHistogramInterval.MONTH, null);
        assertEquals("timestamp_date_histogram_bucket", grouping.getProjectedColumnName());
    }
    ...
    public void testBuildExpressionWithFixedInterval() throws ConversionException {
        DateHistogramGrouping grouping = new DateHistogramGrouping("timestamp", null, DateHistogramInterval.hours(2));
        RexNode expression = grouping.buildExpression(inputRowType, rexBuilder);
    ...
    public void testBuildExpressionWithInvalidField() throws ConversionException {
        DateHistogramGrouping grouping = new DateHistogramGrouping("invalid_field", DateHistogramInterval.MONTH, null);
